...
\textbf{Solution:}\\
Before 6 more Black balls added\\
Let $X$ be a random variable that take value 0 and 1.
\begin{align}
X=
\begin{cases}
...
\end{align}
\begin{align}
	\pr{X=1}&=\frac{\text{Total black balls}}{\text{Total balls}}\\
	&=\frac{x}{12}
\end{align}
After 6 more Black balls added\\
Let $Y$ be a random variable that take value 0 and 1.
\begin{align}
Y=
\begin{cases}
	1, &\text{Selected ball is black}\\
...
\end{align}
\begin{align}
\pr{Y=1}&=\frac{\text{Total black balls}}{\text{Total balls}}\\
&=\frac{x+6}{18}
\end{align}
